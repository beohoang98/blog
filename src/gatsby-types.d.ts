...
type BioQueryQuery = { readonly site: { readonly siteMetadata: { readonly author: { readonly name: string | null, readonly summary: string | null, readonly image: string | null } | null, readonly social: { readonly twitter: string | null } | null } | null } | null };
